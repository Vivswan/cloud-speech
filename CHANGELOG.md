...
## [2.0.0](https://github.com/Vivswan/cloud-speech/compare/v1.0.8...v2.0.0) (2026-08-05)
...
* drop code_quality ruleset rule the rulesets API rejects ([2d2b63c](https://github.com/Vivswan/cloud-speech/commit/2d2b63cef96008c11780b2a84932506b4f5cd1d7))
* extract the theme init script without a tag regex ([1a9feac](https://github.com/Vivswan/cloud-speech/commit/1a9feaca9b0199c2e866316cb5307910f96bb2e7))
* gate merges on CodeQL warnings as well as errors ([1ebb1cd](https://github.com/Vivswan/cloud-speech/commit/1ebb1cdbfe0bbf1d7eb110decc1fbbfe0789309c))
* handle string suggested_key in shortcut fallback ([4c7eff2](https://github.com/Vivswan/cloud-speech/commit/4c7eff21573a3946351521b09b549fa61bf42227))
* hide store links until listings are published ([16e3eb4](https://github.com/Vivswan/cloud-speech/commit/16e3eb4a5cc38785585a41924711646ecf23a492))
...
* make the audio element the owner of playback and preview state ([4833cbb](https://github.com/Vivswan/cloud-speech/commit/4833cbb40a087331aed829f5e4ee5f1ffa8f6158))
