// A valid MPEG-1 Layer III stream of silence, built frame by frame so the
// e2e suite needs no audio fixture and no encoder. Every frame is the
// 4-byte header, the 17-byte mono side info, and zero main data: with all
// side-info fields zero the decoder finds no coded values and emits silence.
...
// Sync (11 bits), MPEG-1, Layer III, no CRC | 32 kbps, 44.1 kHz, no padding
// | mono, no emphasis.
