...
// fakeBrowser leaves runtime.getManifest unimplemented (it throws); under the default double the build reads
// as unpacked, no update_url. Tests that need a store install spy over this with their own manifest.
